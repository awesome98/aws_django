...
AWS_S3_REGION_NAME = os.getenv('S3_REGION')  # 버킷이 위치한 리전
...
DATABASES = {
    "default": {
        ...
        "NAME": "hoseop-db", # mysql의 scheme랑 일치해야한다.
        "USER": "admin",
        "PASSWORD": "fisa0903",
        "HOST": "hoseop-fisa-db.cfaa2gyks0rb.ap-northeast-2.rds.amazonaws.com",
        "PORT": "3306",
    },
     'OPTIONS': {
